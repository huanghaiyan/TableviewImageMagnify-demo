...
{
    CHTwitterCoverView *view = [[CHTwitterCoverView alloc] initWithFrame:CGRectMake(0,0, kMainScreen_Width, CHTwitterCoverViewHeight) andContentTopView:topView];
...
- (void)layoutSubviews
{
    ...
    if (self.scrollView.contentOffset.y < 0) {
        ...
        topView.frame = CGRectMake(0, -offset, kMainScreen_Width, topView.bounds.size.height);

        self.frame = CGRectMake(-offset,-offset + topView.bounds.size.height, kMainScreen_Width+ offset * 2, CHTwitterCoverViewHeight + offset);
        ...
        topView.frame = CGRectMake(0, 0, kMainScreen_Width, topView.bounds.size.height);

        self.frame = CGRectMake(0,topView.bounds.size.height, kMainScreen_Width, CHTwitterCoverViewHeight);
